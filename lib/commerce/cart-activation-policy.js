...
export function evaluateCartActivation({
  ...
  const variantResolverReady = variantResolverDecision?.status === 'ready'
    ...
    && typeof variantResolverDecision.evidence === 'string'
    && variantResolverDecision.evidence.trim().length > 0;
