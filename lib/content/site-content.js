...
const siteContent = {
  ...
  homepage: {
    // Hero section
    hero: {
      eyebrow: 'Lofoten — Norway',
      headline: 'CARLO\nPHILLIPS',
      description: 'A storm-lit runway language: black stone, cold water, graphite sky, and geometric menswear cut with quiet precision.',
      cta: {
        text: 'Enter The Runway',
        link: '/collections',
      },
    ...
    featuredSections: {
      // First product hero
      productHero1: {
        productId: 'cp-offshore-cpo-overshirt',
        fallbackIndex: 0,
      },
      // Second product hero
      productHero2: {
  ...
  footer: {
    ...
    newsletter: {
      ...
      title: 'Receive runway notes and first access.',
      placeholder: 'Email address',
      button: 'Sign Up',
      success: 'You are on the list.',
      error: 'Could not save that email. Please try again.',
    },
