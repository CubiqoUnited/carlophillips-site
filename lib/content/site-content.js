...
const siteContent = {
  ...
  site: {
    ...
    description: 'A modern luxury lifestyle brand for those who appreciate understated elegance and timeless design.',
  ...
  homepage: {
    ...
    hero: {
      ...
      headline: 'Gesture of\nLuxury',
      description: 'CARLOPHILLIPS and love,Carlo as one visual system: premium essentials, graphic emotion, and product built around a sharper brand world.',
      cta: {
        text: 'Shop Now',
        link: '/collections',
      },
    ...
    brandStatement: {
      ...
      headline: 'We design clothes for people who value quality over quantity, substance over trends.',
      description: 'Every piece is crafted with intention, using premium materials sourced from ethical suppliers. We partner with print-on-demand and dropshipping services that share our commitment to sustainability.',
      cta: {
        text: 'Learn More',
        link: '/about',
      },
