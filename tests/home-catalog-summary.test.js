  ...
  it('minimizes an eligible local catalog decision into a non-commerce review link', () => {
    ...
    expect(summary).toMatchObject({
      ...
      primaryProduct: {
        ...
        heroMedia: {
          url: '/products/signature-hoodie/candidates/modelize/editorial-02.jpg',
          alt: 'CARLOPHILLIPS Signature Hoodie — AI-assisted product visualisation',
        },
        media: [{
          type: 'image',
          url: '/products/signature-hoodie/candidates/modelize/editorial-02.jpg',
    ...
    expect(summary.primaryProduct.media[0].alt.toLowerCase()).not.toMatch(/shopify|modelize|apliiq|generated by/);
  });
