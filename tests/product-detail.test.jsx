...
} from '../components/commerce/product-detail.jsx';
...
describe('commerce product presentation', () => {
  ...
  it('renders the hosted checkout handoff only from the complete server authorization summary', () => {
    ...
    expect(html).toContain(
      'Review delivery and payment before confirming your order'
    );
    expect(html).not.toContain('gid://');
  ...
  it('renders the disclosed Signature Hoodie editorial study only in Preview', () => {
    ...
    expect(previewHtml).toContain(
      'Digital campaign studies created from the Signature Hoodie reference images'
    );
    ...
    expect(previewHtml).toContain(
      'cp-media-fit-contain cp-media-position-center'
    );
