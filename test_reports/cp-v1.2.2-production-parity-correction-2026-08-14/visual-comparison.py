#!/usr/bin/env python3
"""Create deterministic Production-versus-candidate screenshot evidence."""
...
def relative(path: Path) -> str:
    return path.relative_to(ROOT.parents[1]).as_posix()
...
def main() -> None:
    ...
    report = {
        "schemaVersion": "cp.production-visual-comparison.v1",
        "baseline": "https://www.carlophillips.com",
        "candidateMethod": "PR #9 head 55604ac DOM with local worktree CSS injected ephemerally",
