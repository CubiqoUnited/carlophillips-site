LEARNINGS.md — organisation-level lessons that belong to no single skill. “Apliiq silently drops an order when the variant sits on Shop location” is not a skill learning; it is a fact about how this business works, and it needs somewhere to live that a per-skill file cannot provide.
