...
Updated: 2026-08-14
Branch: temporary local branch `codex/cp-v1-2-2-design-system-release`, corrected on exact PR #9 head `55604ac`
...
- PR #8 merged the first v1.2.2 candidate to canonical `main`; its independent parity review remained NO-GO and it was not promoted to Production. PR #9 exact head is `55604acb90878a6973c8c13524608c2191577b64` (`cfef2e3` runtime correction plus governance documentation). This additional local parity correction is not pushed or deployed. Production remains unchanged on approved artifact `bb9568f`; no Shopify write, catalog/order mutation, domain change, or billing action occurred.
