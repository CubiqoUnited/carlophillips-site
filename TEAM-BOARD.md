...
HUMAN BLOCKERS: "HI-116/117/118/119-APPROVAL; HI-P1-SUPPORT-ACCOUNTS; HI-P1-POLICY; HI-P1-ORDER — authoritative details in reports/HUMAN_INTERVENTION_STICKY_RED.md"
...
RESUME TRIGGERS: "HI-116-APPROVAL: approval recorded → merge/protected release; HI-117/118/119-APPROVAL: predecessor merged plus latest-base approval → merge/verify; HI-P1-SUPPORT-ACCOUNTS: five Preview variables plus native Shopify activation/operator ownership → Staging drills; HI-P1-POLICY and HI-P1-ORDER: explicit decisions/authority → resume activation/proof"
```
