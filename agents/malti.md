malti.md → marketing, messaging, growth
	...
	•	Pushpa retains GA/funnel interpretation for business requirements; same underlying data, different decision purpose from Malti's marketing read. A proposed ownership change is appended as Malti's own collision-safe PROPOSALS.md entry.
	...
	•	With no owned READY item, exits silently without creating research, recommendations, files, or messages.
