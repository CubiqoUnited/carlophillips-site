...
export const brands = {
  carlophillips: {
    ...
    description:
      'Premium menswear for those who appreciate understated elegance.',
    ...
    hero: {
      ...
      headline: 'Quiet\nLuxury',
      description:
        'Premium menswear crafted for those who appreciate understated elegance and uncompromising quality.',
      cta: 'Shop Collection',
    },

    // Flat lay image for this brand
    flatLayImage:
      'https://customer-assets.emergentagent.com/job_c8d11765-3066-436d-8118-a3922c519218/artifacts/1j7v5dws_ChatGPT%20Image%20Mar%2024%2C%202026%2C%2008_19_07%20AM.png',
  ...
  lovecarlo: {
    ...
    description:
      'Vibrant, colorful pieces that let you express your unique style.',
    ...
    hero: {
      ...
      headline: 'Love\nCarlo',
      description:
        'Bold colors, playful designs, and streetwear energy for the modern trendsetter.',
      cta: 'Shop Now',
    },
  ...
  houseofcarlo: {
    ...
    description:
      'Premium home goods and lifestyle accessories for refined living.',
    ...
    hero: {
      ...
      headline: 'House of\nCarlo',
      description:
        'Elevate your space with thoughtfully designed home goods and lifestyle essentials.',
      cta: 'Explore Home',
    },
 ...
 */
export function detectBrandFromDomain(hostname: string): keyof typeof brands {
...
export function getBrand(brandId: string) {
  if (brandId in brands) return brands[brandId as keyof typeof brands];
...
export function getAllBrands() {
  return brandOrder.map((id) => brands[id as keyof typeof brands]);
}
